...
def atlantic(game_state=None) -> dict:
    ...
    atlantic_wins = game_state["atlantic_wins"] if game_state else 0
    ...
    while running:
        ...
        atlantic_wins_text = font.render(f"atlantic wins: {atlantic_wins}", True, (255, 255, 255))
        screen.blit(atlantic_wins_text, (650, 50))
